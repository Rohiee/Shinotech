...
if ( !is_admin() ) {
	...
	if( is_rtl() ){
		wp_enqueue_style( 'bootstrap-rtl',  BUILDBENCH_CSS . '/bootstrap.min-rtl.css', null,  BUILDBENCH_VERSION );
	}
...
if ( !is_admin() ) {
	...
	if( is_rtl() ){
		wp_enqueue_script( 'bootstrap-rtl', BUILDBENCH_JS . '/bootstrap.min-rtl.js', array( 'jquery' ), BUILDBENCH_VERSION, true );
	}
